...
template <> struct is_proto_enum< ::meta::TimeUnit> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::meta::TimeUnit>() {
  return ::meta::TimeUnit_descriptor();
}
template <> struct is_proto_enum< ::meta::Epoch> : ::google::protobuf::internal::true_type {};
template <>
